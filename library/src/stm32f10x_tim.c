...
#define CCER_CCxE_Enable 1
#define CCER_CCxE_Disable 0


void TIM_OC_Config(TIM_TypeDef* TIMx,u16 output_enable,u16 channel,u16 pulse,u16 ocmode)
{
	TIM_OCInitTypeDef  TIM_OCInitStruct;
	if(ENABLE == output_enable)
	TIM_OCInitStruct.TIM_Output_Enable = CCER_CC1E_Set<<(channel*4);
	else
		TIM_OCInitStruct.TIM_Output_Enable = CCER_CCxE_INIT;
	if(pulse > 0xff){
		pulse = 0xfe;
	}else if(pulse < 0x05) {
		pulse = 0x05;
	}
	TIM_OCInitStruct.TIM_Channel = channel;
	TIM_OCInitStruct.TIM_OCMode = ocmode;
      ...
      (TIM_OCInitStruct->TIM_Channel == (u16)TIM_Channel_2))
  {
    ...
    if (TIM_OCInitStruct->TIM_Channel == TIM_Channel_1)
    {
     ...
     // tmpccer |= CCER_CC1E_Set;
         tmpccer |= TIM_OCInitStruct->TIM_Output_Enable?CCER_CC1E_Set:0;
    ...
    else /* TIM_Channel_2 */
    {
     ...
     // tmpccer |= CCER_CC2E_Set;
         tmpccer |= TIM_OCInitStruct->TIM_Output_Enable?CCER_CC2E_Set:0;
      /* Set the Capture Compare Polarity */
    ...
    { 
      ...
      if (TIM_OCInitStruct->TIM_Channel == TIM_Channel_3)
      {
        ...
        //tmpccer |= CCER_CC3E_Set;
         tmpccer |= TIM_OCInitStruct->TIM_Output_Enable?CCER_CC3E_Set:0;
        /* Set the Capture Compare Polarity */
      ...
      else  /* TIM_Channel_4 */
      {
       ...
       /* Select the Output Compare Mode */
        ...
        /* Set the Capture Compare Enable Bit */
         ...
         tmpccer |= TIM_OCInitStruct->TIM_Output_Enable?CCER_CC4E_Set:0;
        /* Set the Capture Compare Polarity */
